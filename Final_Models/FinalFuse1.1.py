...
class MultiModalEmotionDetector:
    ...
    def load_models(self):
        ...
        try:
            ...
            expected_input_size = fc1_weight_shape[1]
            feature_map_size = expected_input_size // 32
            ...
            self.sound_model.eval()
            print("⚠ Sound model not found, using dummy model")
        ...
        try:
            ...
            self.prosody_model.eval()
            print("⚠ Prosody model not found, using dummy model")
    ...
    def init_bart_feedback(self):
        ...
        try:
            ...
            print("⚠ BART model failed to load")
        ...
        for aspect, text in feedback_aspects.items():
            try:
                ...
                with torch.no_grad():
                    ...
                    score = probs[0][2].item()  # entailment probability
                    scores[aspect] = score
            except:
                scores[aspect] = 0.5
        return scores
    ...
    def draw_results(self, frame):
        ...
        y_pos += line_height
        cv2.putText(panel, f"Sound: {sound_emotion}", (10, y_pos), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 255, 255), thickness)
        y_pos += line_height
    ...
    def run(self):
        ...
        while True:
            ...
            if fps_counter >= 30:
                ...
                print(f"🔊 Sound Emotion: {results_copy['sound_emotion']}")

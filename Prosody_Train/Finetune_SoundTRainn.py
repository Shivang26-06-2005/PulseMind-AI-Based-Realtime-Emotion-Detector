...
model.load_state_dict(torch.load("prosody_net.pth"))

# Loss and optimizer (all layers trainable)
...
for epoch in range(10):
    ...
    print(f"Fine-tune Epoch {epoch+1}, Loss: {running_loss/len(dataloader):.4f}")

# Save fine-tuned model
torch.save(model.state_dict(), "prosody_net_finetuned_all.pth")
print("✅ Fine-tuning complete, saved as prosody_net_finetuned_all.pth")
